        ...
        {Array.from({ length: maxRating }).map((_, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "transition-transform cursor-pointer hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-sm",
              )}
            >
              <Star
                className={cn(
